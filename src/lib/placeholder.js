...
export function getHeroPlaceholder(heros) {
    // console.log("🚀 ~ file: placeholder.js ~ line 177 ~ getHeroPlaceholder ~ heros", heros.length)
    ...
    return heros.map((hero, index) => {
        ...
        // console.log("🚀 ~ file: placeholder.js ~ line 190 ~ returnheros.map ~ placeholder", placeholder)
